...
*/
  ...
  */
  /*
Remove specials caractères from string
*/
  ...
  /*
  Remove duplicate object from array specific
  */
  ...
  */
  delDuplicateObject(liste: any, object: any) {
    const test = liste;
    const new_test = object;
    // new_test[0].regNom=test[0].regNom;
    new_test[0] = test[0];
  ...
  */
  ...
  /*
Verify if object exist in array
  */
...
// console.log(items);
  ...
  /*
 objet exist specifique
  */
  objectExistByStstus(items: any, valu: any) {
   // console.log(valu.sessStatus)
    let result: any = false;
    items.forEach(value => {
      // console.log(value.sessStatus)
      if ((value.sessStatus == valu)) {
        result = true;
      }
  ...
  */
  ...
  /*
 RemoveElementFromObjectArray
  */
   RemoveElementFromObjectArray(array: any, idEtudiant: any) {
     array.forEach((value, index) => {
      if (value.id === idEtudiant) { array.splice(index, 1); }
    });
     return array;
  }
